...
def parse_boi(pdf_path, password=None, areas=None):
    rows = []
...
def convert_boi(pdf_path, password=None, areas=None):
    df = parse_boi(pdf_path, password, areas=areas)
    out_path = get_save_path("BOI", pdf_path)
