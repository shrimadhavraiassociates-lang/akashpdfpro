...
def parse_bob(pdf_path, password=None, areas=None):
    rows = []
...
def convert_bob(pdf_path, password=None, areas=None):
    df = parse_bob(pdf_path, password, areas=areas)
    out_path = get_save_path("BOB", pdf_path)
