...
def parse_indusind(pdf_path, password=None, areas=None):
    rows = []
...
def convert_indusind(pdf_path, password=None, areas=None):
    df = parse_indusind(pdf_path, password, areas=areas)
    out_path = get_save_path("IndusInd", pdf_path)
